<?php
    ...
    // step 0 controllo se la sessione è scaduta o meno
    _checkSession("cCorrentista");
    // step 1
    $cCorrentista = $_SESSION["cCorrentista"];//Prendo dalla sessione il codice correntista
    ...
    "WHERE movimenti.cConto=conti.cConto AND movimenti.cOperazione=operazioni.cOperazione " . // .->campo
