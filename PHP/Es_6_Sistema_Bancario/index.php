	...
	<div class="form-group alert alert-info" id="wrapBanche">
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<!--Caricamento dinamico di banche-->
				<select class="form-control" id="lstBanche"><!--riga 69-78 accettate solo con estensione .php, in html non viene accettato-->
					<?php //"Continuazione della select"
						require("servizi/php-mysqli.php");
						$con = _connection();
						$sql = "SELECT cBanca, Nome FROM banche";
						$rs = _execute($con,$sql); //Esecuzione query; rs-> vettore enumerativo
						foreach($rs as $item){
